...
const TryCard = ({ heading, img, vid }) => {
  return (
    <a href="/" className="min-w-[200px] md:min-w-[400px] lg:min-w-[500px]">
      <div className="bg-[#272932] rounded-3xl p-5 flex justify-center items-center relative object-contain">
        ...
        <h1 className="absolute left-[0%] bottom-[10%] -rotate-90 text-[#FFFFFF]">
          {heading}
        </h1>
      </div>
    </a>
