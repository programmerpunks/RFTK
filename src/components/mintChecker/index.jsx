...
const MintChecker = () => {
  return (
    <>
      <div className="flex px-4 md:px-60 md:py-20 flex-col flex-wrap md:p-0 w-full overflow-hidden justify-center" id="MINT">
        ...
        <div className="flex lg:flex-nowrap flex-wrap bg-[#272733] rounded-3xl">
          <img
            ...
            alt="/"
          />
          <div className="flex md:py-0 py-14 px-4  flex-col md:px-20 justify-center">
            ...
            <div className="flex py-5 justify-center">
              <input
                className="shadow bg-transparent border rounded-2xl text-sm flex flex-wrap p-2 md:p-[16px] py-2 text-[#A3A6B5]"
                type="text"
